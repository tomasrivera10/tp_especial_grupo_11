# tp_especial_grupo_11

# Trabajo Especial - Fundamentos de Ciencia de Datos
...
1) Crear un entorno virtual  (ver instrucciones dependiendo del sistema operativo que esta utilizando)
2) Instalar dependencias con `pip install -r requirements.txt`  
3) Abrir la notebook y ejecutar las celdas
